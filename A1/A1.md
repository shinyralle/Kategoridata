...
``` r
gee2 <- loglm(~gender+admission,cont_table2)
...
```
    ...
    ##   men   0.5432854 0.4791433 0.6155486
...
``` r
riskratio(cont_table2,rev="neither")  
```
    ...
    ## gender   estimate     lower   upper
    ##   women 1.0000000        NA      NA
    ##   men   0.7966202 0.7612901 0.83359
    ## 
    ## $p.value
    ##        two-sided
