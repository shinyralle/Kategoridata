...
standardfelet för $\widehat{\sigma}(\text{stickprovsoddskvot}) = 1.425085$  och att konfidensintervallet för blir (`r vanster_andpunkt`,`r hoger_andpunkt`). 
...
och när vi räknar ut denna får vi att den blir `r stickprovsriskkvot`. Vi räknar med hjälp av formeln 3.5 på sida 71 ut standradfelet för stickprovsriskkvoten, nedan:
...
och räknar vi ut denna genom att mata in värden så blir det `r se_log_stickprovsriskkvot`. Med andra ord är vårt estimat att män är `r se_log_stickprovsriskkvot` så sannolika att vara emot laglig abort som kvinnor. Vi kan sedan skapa konfidensintervallet för stickprovssriskkvoten med hjälp av formeln för ändamålet på sid  71 i kurslitteraturen
...
`r percentagematrix2 %>% knitr::kable()`
`r gee2pearsonX2$tests %>% knitr::kable()`
`r oddsratio2$measure %>% knitr::kable()`
`r riskratio2$measure %>% knitr::kable()`
...
`r percentagematrix3 %>% knitr::kable()`
`r gee2pearsonX3$tests %>% knitr::kable()`
`r oddsratio3$measure %>% knitr::kable()`
`r riskratio3$measure %>% knitr::kable()`
...
`r percentagematrix4 %>% knitr::kable()`
`r gee2pearsonX4$tests %>% knitr::kable()`
`r oddsratio4$measure %>% knitr::kable()`
`r riskratio4$measure %>% knitr::kable()`
