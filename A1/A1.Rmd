...
percentage_matrix2 <- (diag(1 / women_men) %*% cont_table2) * 100
...
#Calculate risk/odds ratio and confidence interval
library(epitools)    # the epitools package must be installed #
oddsratio2 <- oddsratio(cont_table2,rev="neither")
odds_ratio2statistic <- oddsratio2$measure

# odds_ratio2statistic
# oddsratio2$measure

riskratio2 <- riskratio(cont_table2,rev="neither")  
```
...
#Calculate risk/odds ratio and confidence interval
library(epitools)    # the epitools package must be installed #
oddsratio3 <- oddsratio(cont_table3,rev="neither")
riskratio3 <- riskratio(cont_table3,rev="neither")  
```
...
#Calculate risk/odds ratio and confidence interval
library(epitools)    # the epitools package must be installed #
oddsratio4 <- oddsratio(cont_table4,rev="neither")
riskratio4 <- riskratio(cont_table4,rev="neither")  
